...
index_1.xlsxBuildByTemplate(testData, __dirname + '/../test-data/xlsx-template-ex-0.xlsx')
    .then((buffer) => {
...
index_1.xlsxBuildByTemplate(testData, __dirname + '/../test-data/xlsx-template-ex-1.xlsx')
    .then((buffer) => {
...
index_1.xlsxBuildByTemplate(testData, __dirname + '/../test-data/xlsx-template-ex-2.xlsx')
    .then((buffer) => {
